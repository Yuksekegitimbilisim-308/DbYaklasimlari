...
using EfCoreScaffold.Entities;
using Microsoft.EntityFrameworkCore;

namespace EfCoreScaffold.Contexts;
...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<EnCokSatisYapanPersoneller> EnCokSatisYapanPersonellers { get; set; }
    ...
    public virtual DbSet<VTeslimEdilmeyenSiparisler> VTeslimEdilmeyenSiparislers { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-OBCSS28;Database=Northwind;User Id=sa;Password=1234;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EnCokSatisYapanPersoneller>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("EnCokSatisYapanPersoneller");

            entity.Property(e => e.BirimPirimFiyatı).HasColumnName("Birim Pirim Fiyatı");
            entity.Property(e => e.Personel).HasMaxLength(31);
            entity.Property(e => e.SatışSayısı).HasColumnName("Satış Sayısı");
            entity.Property(e => e.ÖdenecekPrimTutarı).HasColumnName("Ödenecek Prim Tutarı");
        });
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.ToTable("Order Details", tb => tb.HasTrigger("InsertOrderDetailsWithProduct"));
        ...
        modelBuilder.Entity<VTeslimEdilmeyenSiparisler>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("v_TeslimEdilmeyenSiparisler");

            entity.Property(e => e.CezaBedeli).HasColumnName("Ceza Bedeli");
            entity.Property(e => e.CompanyName).HasMaxLength(40);
            entity.Property(e => e.TeslimEdilmeyenKargoSayısı).HasColumnName("Teslim Edilmeyen Kargo Sayısı");
        });
